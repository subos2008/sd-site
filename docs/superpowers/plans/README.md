...
| 03  | [Profile Depth + Likes](./2026-05-14-03-profile-depth-likes.md) | written, not executed | Full profile fields (physical, lifestyle, interests), multiple photos, like/unlike, Likes tab, search filters, in-app banners.                                                                       |
